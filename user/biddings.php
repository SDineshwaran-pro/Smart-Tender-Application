    ...
    <div class="mother-grid">
        <div class="container">
            <div class="temp-padd">
                ...
                $id = $_GET['id'];
                $charge="SELECT Price from tender where TenderID='$id'";
                $sql = "SELECT * FROM organization where OrgID='$Orgid'";
                $query = mysqli_query($conn, $sql);
                $query1 =mysqli_query($conn,$charge);
                ...
                <div class="container d-flex align-items center justify-content-center">
                    <form class="form-horizontal" action="insertIntoTable.php" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control mb-2" type="float" name="Charge" id="Charge"  value="<?php echo $row2['Price']-(($row2['Price'])*$row['Per']/100) ?>"required>
                            </div>
                        </div>
                        <div class="form-group row">
